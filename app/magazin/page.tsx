                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <Link href="/magazin/5-nejkrasnejsich-jezer-svycarska" className="group relative h-[400px] rounded-3xl overflow-hidden block bg-white border border-slate-200 flex flex-col">
                        <div className="relative h-48 overflow-hidden">
                            <Image
                                src="/images/lakes/vierwaldstattersee.png"
                                alt="Švýcarsko"
                                fill
                                className="object-cover transition-transform duration-700 group-hover:scale-105"
                            />
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                            ...
                            <p className="text-slate-500 text-sm line-clamp-3 mb-4 flex-1">
                                Švýcarsko není jen o horách. Objevte tyrkysová jezera, která vypadají jako z Karibiku.
                            </p>
                    ...
                    {/* Article 2 - Rome */}
                    <Link href="/magazin/rim-vecne-mesto-za-vikend" className="group relative h-[400px] rounded-3xl overflow-hidden block bg-white border border-slate-200 flex flex-col">
                        <div className="relative h-48 overflow-hidden">
                            <Image
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                            <span className="inline-block px-3 py-1 bg-purple-100 text-purple-700 text-xs font-bold rounded-full mb-4 w-fit uppercase tracking-wider">
                                City Break
                            </span>
                            <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-blue-600 transition-colors">
                                Řím: Věčné město za víkend
                            </h3>
                            <p className="text-slate-500 text-sm line-clamp-3 mb-4 flex-1">
                                Jak stihnout Koloseum, Vatikán a sníst co nejvíc pizzy za pouhých 48 hodin.
                            </p>
                            <span className="text-blue-600 font-bold text-sm">Číst více →</span>
                        </div>
                    </Link>
                    ...
                    {/* Article 3 - Maldives */}
                    <Link href="/magazin/maledivy-raj-na-zemi-bez-cestovky" className="group relative h-[400px] rounded-3xl overflow-hidden block bg-white border border-slate-200 flex flex-col">
                        <div className="relative h-48 overflow-hidden">
                            <Image
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                            <span className="inline-block px-3 py-1 bg-cyan-100 text-cyan-700 text-xs font-bold rounded-full mb-4 w-fit uppercase tracking-wider">
                                Exotika
                            </span>
                            <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-blue-600 transition-colors">
                                Maledivy bez cestovky a levně
                            </h3>
                            <p className="text-slate-500 text-sm line-clamp-3 mb-4 flex-1">
                                Zapomeňte na předražené resorty. Ukážeme vám, jak si užít ráj i s normálním rozpočtem.
                            </p>
                            <span className="text-blue-600 font-bold text-sm">Číst více →</span>
                        </div>
                    </Link>
                    ...
                    {/* Article 4 - Madeira */}
                    <Link href="/magazin/madeira-ostrov-vecneho-jara" className="group relative h-[400px] rounded-3xl overflow-hidden block bg-white border border-slate-200 flex flex-col">
                        <div className="relative h-48 overflow-hidden">
                            <Image
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                            ...
                            <p className="text-slate-500 text-sm line-clamp-3 mb-4 flex-1">
                                Divoká příroda, levády a hory. Ideální destinace pro aktivní dovolenou po celý rok.
                            </p>
                            <span className="text-blue-600 font-bold text-sm">Číst více →</span>
                        </div>
                    </Link>

                    {/* Placeholder Article - Airport Guides Link */}
                    <Link href="/pruvodce" className="group relative h-[400px] rounded-3xl overflow-hidden block bg-blue-600 flex flex-col justify-center items-center text-center p-8">
                        ...
                        <p className="text-blue-100 mb-8 relative z-10 max-w-sm mx-auto">
                            Odletáte z Prahy, Vídně nebo Krakova? Podívejte se na naše detailní průvodce.
                        </p>
