...
export const metadata = {
    title: 'Průvodce Letištěm M.R. Štefánika Bratislava (BTS) | Flugi',
    description: 'Malé letiště s velkým srdcem. Ideální pro lety do exotiky se Smartwings.',
};
            ...
            <header className="relative h-[60vh] flex items-end">
                ...
                <div className="container mx-auto px-4 relative z-10 pb-12 text-white">
                    ...
                    <p className="text-xl md:text-2xl text-white/90 max-w-3xl font-light">
                        Oblíbené pro lety k moři. Kompaktní, rychlé a blízko slovenských hranic.
                    </p>
                </div>
            </header>
                ...
                <div className="lg:col-span-2 space-y-8 prose prose-lg prose-slate max-w-none">
                    <section>
                        <h2 className="flex items-center gap-3 text-2xl font-bold text-slate-900">
                            <Train className="text-blue-600 h-6 w-6" /> Doprava
                        </h2>
                        <p>Z Brna jste tu za 90 minut autem (D2). Vlakem dojeďte na Hlavnú stanicu, pokračujte autobusem 61.</p>
                    </section>
                </div>
